...
@external
func test_add_squares_invalid_caller{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}():
...
@external
func test_add_squares_commit_hashes{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}():
...
# Note: This is the original test of test_add_squares
@external
